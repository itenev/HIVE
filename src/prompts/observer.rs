...
```json
{
  ...
  "failure_category": "ghost_tooling" | "lazy_deflection" | "tool_underuse" | "tool_overuse" | "architectural_leakage" | "sycophancy" | "confabulation" | "unparsed_tools" | "actionable_harm" | "capability_hallucination" | "stale_knowledge" | "none",
